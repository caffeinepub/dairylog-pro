...
export function StaffPage() {
  ...
  const handleDeleteAdvance = async () => {
    ...
    try {
      await deleteAdvance.mutateAsync(deleteAdvanceId);
  ...
  return (
    <div className="animate-fade-in">
                ...
                <div className="mb-4 bg-muted/50 rounded-lg p-4 space-y-3 border border-border">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setAdvanceForm((f) => ({ ...f, note: e.target.value }))
                      }
                  ...
                  {staffAdvances.map((adv, idx) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        data-ocid={`advance.delete_button.${idx + 1}`}
      ...
      <AlertDialog
        ...
        onOpenChange={() => setDeleteAdvanceId(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
